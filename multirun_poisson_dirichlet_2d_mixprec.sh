...
#         do
#             ./poisson_dirichlet_2d_mixprec --meshfile ../data/meshes/unit-square-quad.xml --mem $memtype --vtk --logto output.data --statistics --level $lvlH $lvlL --maxiter $miter --deftol 1E-$tol > output.log
...
do
  ...
  do
    ...
    do
         ...
         ./poisson_dirichlet_2d --meshfile ../data/meshes/unit-square-quad.xml --mem $memtype --vtk --statistics --level $lvlH $lvlL > output.log
         #foulderName = "$lvlH_$lvlL_miter$miter_tol$tol"
